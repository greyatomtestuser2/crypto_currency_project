...
from ..build import q07_make_stationary
import matplotlib.pyplot as plt
import pandas as pd
import numpy as np

df = q07_make_stationary('data/bitcoin.csv')


class TestRead_csv_data_to_df(TestCase):

    def test_read_csv_data_to_df_args(self):
        arg = getfullargspec(q07_make_stationary).args
    ...
    def test_values(self):
        self.assertAlmostEqual(df.iloc[100,7], 0.04948716546783505,2, "The Expected return value does not match with the given return value")